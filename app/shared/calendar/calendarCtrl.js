...
scheduleApp.controller('calendarCtrl',
   function($scope, $compile, $timeout, uiCalendarConfig) {
    ...
    /* if have time leave it as true and link the events to the datamodel */
    $scope.uiConfig = {
      calendar:{
        height: 450,
        editable: false,
    ...
    /* event sources array*/
    // guy comment - not clear why we have 2 sources the second source list was not presented  - but on origianl file it was working */
